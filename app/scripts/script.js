...
var apiRoot = 'http://samta.saleorpurchase.com/';
var gsessions = [];
                      ...
                      success(function (data, status, headers, config) {
                          if (status == 200) {
                             ...
                             localStorage.setItem("password", $scope.uniquID);
                              ...
                              localStorage.setItem("Secondspassed", "")
                              localStorage.setItem("participants", "");
                              localStorage.setItem("sessionId", "")
                              localStorage.setItem("laneSelected","")
                              localStorage.setItem("SessionSelectedId", "")
                              localStorage.setItem("sessionId", "")
                              localStorage.setItem("laneCount", "")
                              localStorage.setItem("laneId", "");
                              localStorage.setItem("participants", "");
                              localStorage.setItem("Secondspassed", "")
